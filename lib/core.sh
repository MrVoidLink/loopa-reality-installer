...
CONN_STATS_SCRIPT="/usr/local/bin/loopa-connection-stats.py"
CONN_STATS_LOGROTATE="/etc/logrotate.d/loopa-xray-access"
CONN_STATS_LOGROTATE_STATE="/var/lib/logrotate/loopa-xray-access.state"
CONN_STATS_ROTATE_SERVICE="/etc/systemd/system/loopa-xray-logrotate.service"
CONN_STATS_ROTATE_SERVICE_NAME="loopa-xray-logrotate.service"
